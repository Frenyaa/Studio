...
<head>
    ...
    <title>@yield('title', ($siteName ?? config('app.name')) . ' — Nội Thất Cao Cấp | Tối Giản Sang Trọng')</title>
    ...
    <link href="https://fonts.googleapis.com/css2?family=Cormorant+Garamond:wght@300;400;500;600;700&family=Be+Vietnam+Pro:wght@300;400;500;600&display=swap" rel="stylesheet">
