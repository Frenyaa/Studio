...
<head>
    ...
    <title>@yield('title', config('app.name') . ' — Thiết kế & Thi công Nội thất')</title>
    <meta name="description" content="@yield('meta_description', config('app.name') . ' — Thiết kế thi công toàn diện cho ngôi nhà của bạn. Phong cách tối giản sang trọng.')">
