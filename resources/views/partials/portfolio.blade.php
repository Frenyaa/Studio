...
<section id="portfolio" class="bg-cream-deep py-24 lg:py-32">
    <div class="mx-auto max-w-7xl px-6 lg:px-10">
        ...
        @if ($featuredProjects->isEmpty())
            <p class="text-center text-ink-muted">Chưa có dự án nổi bật. Hãy thêm dự án trong trang quản trị.</p>
        @else
            {{-- Lưới dự án --}}
            ...
            <div class="reveal mt-16 text-center">
                <a href="{{ route('projects.index') }}" class="btn-line border-ink/70 text-ink hover:bg-ink hover:text-cream">
                    Xem toàn bộ dự án
