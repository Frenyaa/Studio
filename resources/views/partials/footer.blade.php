    ...
    <div class="mx-auto max-w-7xl px-6 py-20 lg:px-10">
        <div class="grid gap-12 lg:grid-cols-5">
            ...
            <div class="lg:col-span-2">
                ...
                <p class="mt-6 max-w-sm text-sm leading-relaxed text-cream/60">
                    Thiết kế & thi công nội thất toàn diện theo phong cách tối giản sang trọng —
                    kiến tạo không gian sống tinh tế, bền vững theo thời gian.
                </p>
            </div>
            ...
            <div>
                ...
                <ul class="mt-6 space-y-3 text-sm text-cream/60">
                    <li>Vũ Tông Phan, Thanh Xuân, Hà Nội</li>
                    <li>Hotline: <a href="tel:0900000000" class="transition-colors hover:text-cream">0900 000 000</a></li>
                    <li>Email: <a href="mailto:hello@studio.vn" class="transition-colors hover:text-cream">hello@studio.vn</a></li>
                </ul>
            </div>
            ...
            <div>
                ...
                <div class="mt-6 flex gap-4">
                    <a href="#" aria-label="Facebook" class="flex h-10 w-10 items-center justify-center border border-cream/20 transition-colors hover:border-cream hover:text-cream">
                    ...
                    <a href="#" aria-label="Youtube" class="flex h-10 w-10 items-center justify-center border border-cream/20 transition-colors hover:border-cream hover:text-cream">
                    ...
                    <a href="#" aria-label="Tiktok" class="flex h-10 w-10 items-center justify-center border border-cream/20 transition-colors hover:border-cream hover:text-cream">
        ...
        <div class="mt-16 flex flex-col items-center justify-between gap-4 border-t border-cream/10 pt-8 text-xs text-cream/40 sm:flex-row">
            ...
            <p>Thiết kế & Thi công Nội thất — Minimalism Luxury</p>
        </div>
    </div>
</footer>
