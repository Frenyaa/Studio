...
class PartnerResource extends Resource
{
    ...
    {
        return $form->schema([
            Forms\Components\TextInput::make('name')->label('Tên đối tác')->required()->placeholder('Kohler'),
            ...
            Forms\Components\FileUpload::make('logo')
                ...
                ->directory('partners')
                ->required()
                ->helperText('Logo sẽ tự động hiển thị dạng grayscale ở trang chủ.'),

            Forms\Components\TextInput::make('website')->label('Website')->url()->placeholder('https://kohler.com'),
    ...
    public static function table(Table $table): Table
    {
        return $table
            ...
            ->columns([
                Tables\Columns\ImageColumn::make('logo')->label('Logo')->height(40),
                Tables\Columns\TextColumn::make('name')->label('Tên')->searchable(),
                Tables\Columns\TextColumn::make('website')->label('Website')->url(fn ($record) => $record->website)->openUrlInNewTab(),
